...
class AdminFlowsTest < ActionDispatch::IntegrationTest
  ...
  test 'admin can edit room name' do
    patch room_url(:en, rooms(:lulw)), params: { room: { name: 'idkbro' } }
